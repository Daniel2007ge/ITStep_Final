...
let Hotel = globalVariable.Hotels_And_Restourants

let img1 = document.getElementById("star")
img1.setAttribute("src", Hotel[x].stars)

let img2 = document.getElementsByTagName("img")[1]
img2.setAttribute("src", Hotel[x].img)
img2.style = "width: 314px"

let div = document.getElementsByTagName("div")[0]
div.innerHTML = Hotel[x].description

let h1 = document.createElement("h1")
h1.innerText = Hotel[x].name
div.prepend(h1)
...
</svg>`+Hotel[x].location
div.append(span)

let x2 = localStorage.getItem("num2")
